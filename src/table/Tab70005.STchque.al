table 71005 "ST chéque"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Payment Header FR"."Status No." WHERE("No." = FIELD("ST Payment Slip No.")));
            Caption = 'Status No.';
        ...
        {
            CalcFormula = Exist("Payment Header FR" WHERE("No." = FIELD("ST Payment Slip No."),
                                                        "Status No." = CONST(0)));
            Enabled = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Lookup("Payment Line FR"."Account No." WHERE("No." = FIELD("ST Payment Slip No.")));
            Caption = 'Account No';
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("Payment Line FR".Amount WHERE("No." = FIELD("ST Payment Slip No."),
