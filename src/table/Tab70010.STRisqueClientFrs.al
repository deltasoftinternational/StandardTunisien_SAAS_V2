table 71010 "STRisqueClientFRs"
{
    ...
    fields
    {
        ...
        field(4; CltChequeEnCoffreMnt; Decimal)
        {
            ...
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltChequeEnCoffreFilter),
        ...
        field(6; CltChequeImpayeMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltChequeImpayeFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                   "Posting Date" = field("Date Filter"),
                                                                  "Copied To No." = const('')));
        ...
        field(8; CltChequeContentieuxMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltChequeContentieuxFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
        ...
        field(10; CltChequeEncVersMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltChequeEncVersFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                   "Posting Date" = field("Date Filter"),
        ...
        field(13; CltTraiteEnCoffreMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteEnCoffreFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                   "Posting Date" = field("Date Filter"),
        ...
        field(15; CltTraiteRemisEncMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteRemisEncFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                              "Posting Date" = field("Date Filter"),
        ...
        field(17; CltTraiteEncoursEncMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteEncoursEncFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                  "Posting Date" = field("Date Filter"),
        ...
        field(19; CltTraiteRemisEscMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteRemisEscFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                  "Posting Date" = field("Date Filter"),
        ...
        field(21; CltTraiteEncoursEscMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteEncoursEscFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                  "Posting Date" = field("Date Filter"),
        ...
        field(23; CltTraiteImpayeMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteImpayeFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  "Posting Date" = field("Date Filter"),
                                                                  "Copied To No." = const('')));
        ...
        field(25; CltTraiteContentieuxMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltTraiteContentieuxFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  "Posting Date" = field("Date Filter"),
                                                                  "Copied To No." = const('')));
        ...
        field(28; FrsTraiteRemiseMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(FrsTraiteRemiseFilter),
        ...
        field(30; FrsChequeEncoursMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(FrsChequeEncoursFilter),
                                                                  "Account Type" = const(Vendor),
                                                                  "Account No." = field(Code),
                                                                  "Copied To No." = const('')));
        }
        ...
        field(32; FrsTraiteEncoursMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(FrsTraiteEncoursFilter),
                                                                  "Account Type" = const(Vendor),
                                                                  "Account No." = field(Code),
                                                                  "Posting Date" = field("Date Filter"),
                                                                  "Copied To No." = const('')));
        ...
        field(58; CltChequeRemisEscMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltChequeRemisEscFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                  "Posting Date" = field("Date Filter"),
        ...
        field(61; CltChequeEncoursEscMnt; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = - sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field(CltChequeEncoursEscFilter),
                                                                  "Account Type" = const(Customer),
                                                                  "Account No." = field(Code),
                                                                  STCertifAval = const(false),
                                                                  "Posting Date" = field("Date Filter"),
