pageextension 71001 "STD Payment Slip Subform FR" extends "Payment Slip Subform FR" //10848
{
    layout
    {
        ...
        addafter(Amount)
        {
            field("STD ST Amount"; rec.Amount)
            {
                ApplicationArea = all;
                Visible = true;
        ...
        {
            field("STD Created from No."; Rec."Created from No.")
            {
                Editable = false;
                ApplicationArea = All;
            }
            field("STD Copied To No."; Rec."Copied To No.")
            {
                Editable = false;
                ApplicationArea = All;
            }
            ...
            field("STD Assiette RS"; Rec."STAssiette RS")
            {
                ApplicationArea = All;
            }
            field("STD Montant Retenue"; Rec."STMontant Retenue")
            {
                ApplicationArea = All;
            }
            ...
            field("STD Commentaires"; Rec.STCommentaires)
            {
                ApplicationArea = All;
            }
            field("STD Drawee Reference1"; Rec."STDrawee Reference1")
            {
                ApplicationArea = All;
                trigger OnValidate()
                var
            ...
            field("STD En Banque"; Rec."STEn Banque")
            {
                ApplicationArea = All;
            }


            field("STD stMontant Interret"; Rec."STMontant Interret")
            {
                ApplicationArea = all;
                Style = Favorable;
                StyleExpr = TRUE;
            ...
            field("STD stMontant Commission"; Rec."STMontant Commission")
            {
                ApplicationArea = all;
                Style = Favorable;
                StyleExpr = TRUE;
            ...
            field("STD STMontant TVA Commission"; Rec."STMontant TVA Commission")
            {
                ApplicationArea = all;
                Style = Favorable;
                StyleExpr = TRUE;
            ...
            field("STD Invoice No."; Rec."STInvoice No.")
            {
                ApplicationArea = All;
            }

            field("STD Avance ouvert"; Rec."STAvance ouvert")
            {
                ApplicationArea = All;
            }

            field("STD Job No."; Rec."STJob No.")
            {
                ApplicationArea = All;
            }
            ...
            field("STD Code Motif"; Rec.STCode_Motif)
            {
                ApplicationArea = All;
            }
            field("STD Coffre"; Rec.STCoffre)
            {
                Editable = false;
                ApplicationArea = All;
            }
            field("STD Coffre Origine"; Rec."STCoffre Origine")
            {
                Editable = false;
                ApplicationArea = All;
            }
            field("STD Banque Societe"; Rec."Banque Societe")
            {
                Editable = false;
                ApplicationArea = All;
            }
        ...
        addafter("Due Date")
        {
            ...
            field("STD STOrder Type"; Rec."STOrder Type")
            {
                ToolTip = 'Specifies the value of the Order Type field';
                ApplicationArea = All;
            }
            field("STD STOrder No."; Rec."STOrder No.")
            {
        ...
        {
            field("STD STCertifAval"; Rec.STCertifAval)
            {
                ApplicationArea = all;
                trigger OnValidate()
                begin
            ...
            field("STD Applies-to Invoices Nos."; Rec."Applies-to Invoices Nos.")
            {
                ApplicationArea = All;
            }

            field("STD Check No"; rec."ST Check No")
            {
            ...
            field("STD Groupe Comptabilisation"; Rec."STGroupe Comptabilisation")
            {
                ApplicationArea = All;
                Visible = false;
            }
        ...
        addlast(Control1)
        {
            ...
            field("STD Date CIN"; Rec."Date CIN")
            {
                Caption = 'Date CIN';
                ApplicationArea = All;
            }
    ...
    actions
    {
        ...
        addafter(Insert)
        {
            ...
            action("STD Imprimer ordre paiement")
            {
                ApplicationArea = All;
                Image = Print;
                Visible = false;
    ...
    var
        PaymentHeaderV: record "Payment Header FR";
        PaymentStatusV: record "Payment Status FR";
    begin
    ...
    local procedure OnBeforeApplication2(Paymentline: record "Payment Line FR")
    begin
    end;
    ...
    var
        ...
        RecHeader: record "Payment Header FR";
        RecStatus: record "Payment Status FR";
