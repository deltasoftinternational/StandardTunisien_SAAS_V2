report 71000 "STCertif. Retenue a la Source"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/CertifRetenuealaSource.rdl';
    ...
    dataset
    {
        dataitem(PaymentHeader; "Payment Header")
        {
            ...
            dataitem("Payment Line"; "Payment Line")
            {
                ...
                column(PaymentLineMontantInitialDS; "Payment Line"."STMontant Initial")
                {
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                }
                ...
                // {
                // }
                column(PaymentLineMontantRetenueDS; "Payment Line"."STMontant Retenue")
                {
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                }
                column(PaymentLineAmountLCY; "Payment Line"."Amount")
                {
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(FrnsrAddress2; Frnsr."Address 2") { }
                column(FrnsrCity; Frnsr.City) { }
                column(RegionPaysName; RegionPays.Name) { }
                ...
                begin
                    ...
                    if RegionPays.get(Frnsr."Country/Region Code") then;
    ...
    var
        ...
        RegionPays: Record "Country/Region";
}
