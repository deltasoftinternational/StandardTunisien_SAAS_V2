report 70032 "STBordereau de Recep CHQ - NEW"
{
    ...
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/Bordereau de Recep CHQ - NEW.rdl';
        ...
        dataitem("Payment Header"; "Payment Header")
        {
            ...
            dataitem("Payment Line"; 10866)
            {
                ...
                begin
                    ...
                    RecVBankAccount.SETFILTER(RecVBankAccount.Code, '%1', "Bank Account Code");
                    RecVBankAccount.SETRANGE("Vendor No.", "Payment Line"."Account No.");
                    ...
                    END
                        ...
                        IF RecVBankAccount.FINDFIRST() THEN BEGIN
                            EVALUATE(Rkey, FORMAT(RecVBankAccount."RIB Key"));
                            RIB := RecVBankAccount."Bank Branch No." + RecVBankAccount."Agency Code" +
                            RecVBankAccount."Bank Account No." + Rkey;
                        end;
    ...
    var
        ...
        RecVBankAccount: Record "Vendor Bank Account";
}
