report 71010 "STAccount Schedule4"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/AccountSchedule5.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Tableau analyse financiers';
    ...
    dataset
    {
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                column(AccScheduleNameDesc; AccScheduleName.Description)
                {
                }
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    dataitem("Column Layout"; "Column Layout")
                    {
                        ...
                        column(ColumnValuesDisplayed; ColumnValuesDisplayed)
                        {
    ...
    trigger OnPreReport()
    var
        ERR001: Label 'Veuillez saisir la valeur du nom présentation colonne';
    begin
        TransferValues();
        UpdateFilters();
        InitAccSched();
        //>>DELTA CHK 11/03/2014
        RecGCompanyInfo.GET();
    ...
    procedure GetInformation(lNomTabAnalyse: Code[10]; lNomColomn: Code[10]; lDateFiltersFrom: Text[50])
    var
    begin
