report 71003 "STTraite Fournisseur"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/TraiteFournisseur.rdl';
    ...
    dataset
    {
        dataitem(PaymentHeader; 10865)
        {
            ...
            column(BankBranch1; CopyStr(BankAccount."Bank Branch No.", 1, 2))
            {

            }
            column(BankBranch2; CopyStr(BankAccount."Bank Branch No.", 3, 3))
            {
            ...
            dataitem(PaymentLine; 10866)
            {
                ...
                begin
                    ...
                    if (dev = '') or (dev = 'TND') then
                        ...
                        Convert."Montant en texteDevise"(MntTTlettre, ABS(Amount), dev);
                    //<<MIG2013 15022013
