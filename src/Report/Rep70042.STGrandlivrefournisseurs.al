report 70042 "STGrand livre fournisseurs"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/VendorDetailTrialBalance2.rdl';
    ...
    dataset
    {
        dataitem(Vendor; 23)
        {
            ...
            column(NoFiscal; Vendor."VAT Registration No.")
            {
            }
                ...
                dataitem("Detailed Vendor Ledg. Entry"; 380)
                {
                    ...
                    begin
                        ...
                        IF GroupeCompta <> '' THEN
                            SETFILTER("STvendor Posting Group", GroupeCompta);
                    end;
                }
            ...
            begin
                ...
                IF GroupeCompta <> '' THEN
                    VendLedgEntry.SETFILTER("STVendor Posting Group", GroupeCompta);
                ...
                group(Options)
                {
                    ...
                    field("GroupeCompta"; GroupeCompta)
                    {
                        ...
                        var
                            ...
                            PVendorPostingGroups: Page "Vendor Posting Groups";
                        begin
                            CLEAR(lVendorPostingGroup);
                            PVendorPostingGroups.SETTABLEVIEW(lVendorPostingGroup);
                            PVendorPostingGroups.LOOKUPMODE := TRUE;
                            PVendorPostingGroups.EDITABLE := FALSE;

                            IF PVendorPostingGroups.RUNMODAL() = ACTION::LookupOK THEN BEGIN
                                PVendorPostingGroups.GETRECORD(lVendorPostingGroup);
                                GroupeCompta := Text + lVendorPostingGroup.Code;
    ...
    var
        ...
        IsPrintOnlyIfDetail: Boolean;
        IsPrintOnlyIfDetail1: Boolean;
}
