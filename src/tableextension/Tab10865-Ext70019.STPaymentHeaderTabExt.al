tableextension 71019 "Payment Header FR" extends "Payment Header FR" //10835
{
    fields
    {
        modify("Status No.")
        ...
        field(70003; STCoffre; Code[20])
        {
            ...
            trigger OnValidate()
            var
                PayStat: record "Payment Status FR";
            begin
        ...
        field(70007; "STType paiement"; Option)
        {
            ...
            trigger OnValidate()
            var
                PayLine: record "Payment Line FR";
            begin
                //<< DELTA 01 RAD 05/12/2014
        ...
        field(70008; STCodeSituationPaiement; Code[20])
        {
            ...
            trigger OnValidate()
            var
                LRecPaymentLine: record "Payment Line FR";
            begin
    ...
    var
        ...
        PaymentLigne: record "Payment Line FR";
