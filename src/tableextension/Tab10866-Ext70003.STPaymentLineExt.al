tableextension 71003 "Payment Line FR" extends "Payment Line FR" //10837
{
    fields
    {
        modify("Account No.")
        ...
        field(70001; "STMontant Retenue"; Decimal)
        {
            ...
            var
                ...
                RecGPaymentStatus: record "Payment Status FR";
        ...
        field(70034; "ST Check No"; Code[35])
        {
            ...
            trigger OnValidate()
            var
                PaymentHeader_lr: Record "Payment Header FR";
                ...
                lPaymentLine: Record "Payment Line FR";
                lPaymentHeader: Record "Payment Header FR";
        ...
        field(70035; "ST Réference chéque"; Code[10])
        {
            ...
            var
                ...
                lCheckReference: Record "ST Référence chèque";
                lChecks: Record "ST chéque";
                PaymentLine_lr: Record "Payment Line FR";
        ...
        field(70040; "Banque Societe"; Text[50])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Payment Header FR"."Account No." where("No." = field("No."), "Account Type" = filter('Bank Account')));
 ...
 AND ("Account Type" = "Account Type"::Vendor) THEN
  ...
  AND ("Account Type" = "Account Type"::Vendor) THEN
        ...
        field(70059; "ST REG Debit"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = FIELD("ST REG Debit Filter"),
        ...
        field(70061; "ST FED progress"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field("ST FED progress Filter"),
                                                                  "Account Type" = const(Vendor),
                                                                  "STSlip Origin No." = field("No."),
                                                                  "STSlip Origin line No." = field("Line No."),
                                                                   "Copied To No." = const('')));
        ...
        field(70063; "ST FED Accepted"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field("ST FED Accepted filter"),
        ...
        field(70065; "ST FED regle"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field("ST FED Regle filter"),
        ...
        field(70069; "ST Prorogation 1"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field("ST Prorogation 1 filter"),
        ...
        field(70070; "ST Prorogation 2"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field("ST Prorogation 2 filter"),
        ...
        field(70071; "ST Prorogation 3"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = sum("Payment Line FR"."Amount (LCY)" where(STCodeSituationPaiement = field("ST Prorogation 3 filter"),
        ...
        field(70072; "ST LC validity date"; Date)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = lookup("Payment Header FR"."ST LC validity date" where("No." = field("No.")));
        ...
        field(70073; "ST LC shipping date"; Date)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = lookup("Payment Header FR"."ST LC shipping date" where("No." = field("No.")));
        ...
        field(70077; "ST date Prorogation"; date)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = lookup("Payment Line FR"."Due Date" where(STCodeSituationPaiement = field("ST Prorog"),
                                                                  "Account Type" = const(Vendor),
                                                                   "STSlip Origin No." = field("No."),
                                                                    "STSlip Origin line No." = field("Line No."),
                                                                     "Copied To No." = const('')));
        ...
        field(70078; "ST FED currency"; Decimal)
        {
            ...
            Editable = False;
            FieldClass = FlowField;
            CalcFormula = lookup("Payment Line FR"."Currency Factor" where(STCodeSituationPaiement = field("ST Prorog"),
                                                                  "Account Type" = const(Vendor),
                                                                   "STSlip Origin No." = field("No."),
                                                                    "STSlip Origin line No." = field("Line No."),
                                                                     "Copied To No." = const('')));
    ...
    var
        ...
        lPaymentStep: record "Payment Step FR";
        lPaymentLine: record "Payment Line FR";
        GeneralLedgerSetup: record "General Ledger Setup";
        lPaymentHeader: record "Payment Header FR";
        lChecks: Record "ST chéque";
    ...
    var
        RecT: Record "Payment Line FR";
        Wind: Dialog;
        Montantsdef: Decimal;
        RecTmp: Record "Payment Line FR";
        Mntinit: Decimal;
        MntinitDS: Decimal;
        RecPaymLine: Record "Payment Line FR";
    ...
    var
        ...
        RecGPaymentStatus: record "Payment Status FR";
        RecGGeneralLedgerSetup: Record "General Ledger Setup";
        RecGPaymentStatus1: record "Payment Status FR";
        RecGCustomer: Record Customer;
        RecGVendor: Record Vendor;
        RecGCurrency1: Record Currency;
        RecGPaymentStepLedger: record "Payment Step Ledger FR";
        RecGCurrencyExchangeRate: Record "Currency Exchange Rate";
    ...
    var
        ...
        StepT: record "Payment Step Ledger FR";
        RecGPaymentStatus1: record "Payment Status FR";
        RecGCustomer: Record Customer;
        RecGVendor: Record Vendor;
        RecGGeneralLedgerSetup: Record "General Ledger Setup";
        ...
        RecGPaymentStatus: record "Payment Status FR";
        lStepT: record "Payment Step Ledger FR";
        RecGCurrencyExchangeRate: Record "Currency Exchange Rate";
    begin
    ...
    var
        ...
        RecPaymentHeader: record "Payment Header FR";
        Currency: Record Currency;
