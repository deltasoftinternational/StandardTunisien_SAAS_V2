tableextension 71040 "ST FinanceCue EXT" extends "Finance Cue" //9054
{
    fields
    {
        ...
        {
            CalcFormula = - Sum("Payment Line FR".Amount where("Copied To No." = filter(''),
        ...
        {
            CalcFormula = - Sum("Payment Line FR".Amount where("Copied To No." = filter(''), STCodeSituationPaiement = filter('CLT_CHQCONT'),
                                                            STCoffre = field("Coffre utilisateur")
                                                                                   ));
