codeunit 70000 "stPayment-Apply"  /* nous avons ajoute ce CU la necessite d'utilser les fonction onprem*/
{
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"ST Payment Management", 'OnPostInvPostingBufferOnBeforeGenJnlPostLineRunWithCheck', '', false, false)]
    ...
    begin
        GenJnlLine."STCode Retenue à la Source" := InvPostingBuffer[1]."STCode Retenue à la Source";
    end;
    ...
    begin
        ...
        GLEntry."STCode Retenue à la Source" := GenJournalLine."STCode Retenue à la Source";
    end;
    ...
    begin
        ...
        OnAfterApply(GenJnlLine, PaymentLine);
    end;
    ...
    begin
        ...
        OnBeforeApplyCustomer(CustLedgEntry, PaymentLine);
    ...
    local procedure OnAfterApply(GenJnlLine: Record "Gen. Journal Line"; var PaymentLine: Record "Payment Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeApplyCustomer(var CustLedgEntry: Record "Cust. Ledger Entry"; Paymentline: Record "Payment Line")
    begin
    end;
